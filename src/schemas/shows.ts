...
// ENTITY ----------------------------------------------------------------------------------------------------------------------------------
export const sShow = sShowDoc.pipe(S.fieldsAssign({ channel: S.OptionFromNullOr(sChannel) }));

// REVISION --------------------------------------------------------------------------------------------------------------------------------
export const sShowRevision = sShowFields.mapFields(Struct.pick(["apiId", "updated"]));
