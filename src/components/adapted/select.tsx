...
const SELECT = {
  ...
  separator: cva("pointer-events-none -mx-1 h-px bg-border"),
  trigger: cva(
  ...
  triggerIcon: cva("pointer-events-none size-4 text-muted-foreground"),
...
// SCROLL BUTTONS --------------------------------------------------------------------------------------------------------------------------
export function SelectScrollDownButton({ className, ...props }: ComponentProps<typeof SelectPrimitive.ScrollDownArrow>) {
  return (
    <SelectPrimitive.ScrollDownArrow className={cn(SELECT.scrollDownButton(), className)} data-slot="select-scroll-down-button" {...props}>
      <span className="icon-[ph--caret-down]" />
...
export function SelectScrollUpButton({ className, ...props }: ComponentProps<typeof SelectPrimitive.ScrollUpArrow>) {
  return (
    <SelectPrimitive.ScrollUpArrow className={cn(SELECT.scrollUpButton(), className)} data-slot="select-scroll-up-button" {...props}>
      <span className="icon-[ph--caret-up]" />
...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger className={cn(SELECT.trigger(), className)} data-size={size} data-slot="select-trigger" {...props}>
      {children}
      <SelectPrimitive.Icon render={<span className="icon-[ph--caret-down] pointer-events-none size-4 text-muted-foreground" />} />
