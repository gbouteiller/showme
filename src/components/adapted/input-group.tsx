...
const INPUT_GROUP = {
  ...
  button: cva("flex items-center gap-2 text-xs shadow-none", {
    variants: {
      size: {
  ...
  text: cva("flex items-center gap-2 text-muted-foreground text-xs [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none"),
  textarea: cva(
...
// ROOT ------------------------------------------------------------------------------------------------------------------------------------
export function InputGroup({ className, ...props }: ComponentProps<"fieldset">) {
  return <fieldset className={cn(INPUT_GROUP.root(), className)} data-slot="input-group" {...props} />;
}
...
export function InputGroupAddon({
  ...
  align = "inline-start",
  ...props
}: ComponentProps<"div"> & VariantProps<typeof INPUT_GROUP.addon>) {
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: <explanation>
    <div
      className={cn(INPUT_GROUP.addon({ align }), className)}
      data-align={align}
...
export function InputGroupButton({
  ...
  VariantProps<typeof INPUT_GROUP.button> & {
    type?: "button" | "submit" | "reset";
  }) {
  return <Button className={cn(INPUT_GROUP.button({ size }), className)} data-size={size} type={type} variant={variant} {...props} />;
}

// INPUT -----------------------------------------------------------------------------------------------------------------------------------
export function InputGroupInput({ className, ...props }: ComponentProps<"input">) {
  return <Input className={cn(INPUT_GROUP.input(), className)} data-slot="input-group-control" {...props} />;
}

// TEXT ------------------------------------------------------------------------------------------------------------------------------------
export function InputGroupText({ className, ...props }: ComponentProps<"span">) {
  return <span className={cn(INPUT_GROUP.text(), className)} {...props} />;
}

// TEXTAREA --------------------------------------------------------------------------------------------------------------------------------
export function InputGroupTextarea({ className, ...props }: ComponentProps<"textarea">) {
  return <Textarea className={cn(INPUT_GROUP.textarea(), className)} data-slot="input-group-control" {...props} />;
}
