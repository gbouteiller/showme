...
export class UnsupportedAstTagError extends Data.TaggedError("UnsupportedAstTagError")<WithPathAndAstTag> {
  override get message(): string {
    return formatMessage(this.path, `${this.astTag} cannot be converted without losing type safety`);
  }
}
